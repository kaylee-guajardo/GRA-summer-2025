...
$$
L(\psi, \mathbf{p} | \mathbf{y}) = \displaystyle \prod_{i = 1}^{n_{2020}} \displaystyle \prod_{j = 1}^{J_i} \left [ (p_{ij}z_i)^{y_{ij}} (1-p_{ij}z_i)^{1 - y_{ij}}\cdot \psi_i^{z_i}(1-\psi_i)^{1-z_i} \right ]
$$

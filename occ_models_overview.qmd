...
-   $\mathbb{I}_{00} = 1$ if site $i$ is unoccupied by focal species and undetected during visit $j$, $\mathbb{I}_{00} = 0$ otherwise

-   $\mathbb{I}_{10} = 1$ if site $i$ is occupied by focal species but undetected during visit $j$, $\mathbb{I}_{00} = 0$ otherwise

-   $\mathbb{I}_{11} = 1$ if site $i$ is occupied by focal species detected during visit $j$, $\mathbb{I}_{11} = 0$ otherwise

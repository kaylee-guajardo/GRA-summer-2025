...
$$
L(\psi, \mathbf{p} | \mathbf{y}, \mathbf{z}) = \displaystyle \prod_{i = 1}^{n_{2020}} \left [ \psi_i^{z_i}(1-\psi_i)^{1-z_i} \displaystyle \prod_{j = 1}^{J_i} (p_{ij}z_i)^{y_{ij}} (1-p_{ij}z_i)^{1 - y_{ij}} \right ]
$$

...
-   $Z_{i}$ denotes the true occupancy state for a bat species $k$ in grid cell $i$, which is 1 if occupied or 0 if unoccupied
...
-   $\psi_{i}$ is the probability of the focal bat species occurrence at grid cell $i$

-   $p_{11}$ is the rate of detection of the focal bat species at a grid cell given the grid cell is occupied

-   $p_{10}$ is the rate of detection of the focal bat species at a grid cell given the grid cell is unoccupied
